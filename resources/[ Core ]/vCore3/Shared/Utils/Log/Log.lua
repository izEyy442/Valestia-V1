...
Log = Class.new(function(class)
    ...
    RegisterNetEvent("Valestia:Log", function(logType, message, ...)
        self:send(logType, message, ...);
    end);

    ---@param message any
    ---@param ... any
    function self:Info(message, ...)
        --store_get_function("log.info", "^5vCore3 →^7", message, ...);
    ...
    function self:Warn(message, ...)
        --store_get_function("log.warn", "^5vCore3 →^7", message, ...);
    ...
    function self:Error(message, ...)
        --store_get_function("log.error", "^5vCore3 →^7", message, ...);
    ...
    function self:Debug(message, ...)
        --store_get_function("log.debug", "^5vCore3 →^7", message, ...);
    ...
    function self:Success(message, ...)
        --store_get_function("log.success", "^5vCore3 →^7", message, ...);
