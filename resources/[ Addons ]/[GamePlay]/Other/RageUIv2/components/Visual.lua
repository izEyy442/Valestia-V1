...
RegisterNetEvent("RageUIv2:Popup")
AddEventHandler("RageUIv2:Popup", function(array)
    RageUIv2.Popup(array)
end)

---Popup
---@param array table
---@public
function RageUIv2.Popup(array)
    ClearPrints()
...
---@param array table
---@public
function RageUIv2.PopupChar(array)
    if (array.colors == nil) then
        SetNotificationBackgroundColor(140)
    else
        SetNotificationBackgroundColor(array.colors)
