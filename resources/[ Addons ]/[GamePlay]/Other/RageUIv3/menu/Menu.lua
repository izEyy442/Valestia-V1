...
---@return void
---@public
function RageUIv3.Menus:SetStyleSize(StyleName)
    self.WidthOffset = RageUIv3.UI.Style[StyleName or "RageUIv3"].Width
end
...
---@return nil
---@public
function RageUIv3.Menus:EditSpriteColor(color)
