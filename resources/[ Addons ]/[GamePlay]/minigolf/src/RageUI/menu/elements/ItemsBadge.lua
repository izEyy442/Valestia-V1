RageUI.BadgeStyle = {
    ...
    -- Razzway Add
    PlayerIcon = function(Selected)
        return {
            BadgeTexture = "leaderboard_players_icon",
            BadgeDictionary = "mpleaderboard",
            BadgeColour = Selected and { R = 235, G = 52, B = 79, A = 255 } or { R = 235, G = 52, B = 79, A = 255 }
        }
    end,
    LeaderBoardBikers = function()
        return {
            BadgeTexture = "leaderboard_bikers_icon",
            BadgeDictionary = "mpleaderboard"
        }
    end,
    LeaderBoardFriends = function()
        return {
            BadgeTexture = "leaderboard_bikers_icon",
            BadgeDictionary = "mpleaderboard"
        }
    ...
    Lap = function()
        return {
            BadgeTexture = "leaderboard_lap_icon",
            BadgeDictionary = "mpleaderboard"
        }
    end,
    Plus = function()
        return {
            BadgeTexture = "menuplus_32",
            BadgeDictionary = "shared",
        }
    end,
    VoteCross = function()
        return {
            BadgeTexture = "leaderboard_votecross_icon",
            BadgeDictionary = "mpleaderboard"
        }
    end,
    VoteTick = function()
        return {
            BadgeTexture = "leaderboard_votetick_icon",
            BadgeDictionary = "mpleaderboard"
        }
    end,
    Spec = function()
        return {
            BadgeTexture = "spectating",
            BadgeDictionary = "mphud"
        }
    end,
}