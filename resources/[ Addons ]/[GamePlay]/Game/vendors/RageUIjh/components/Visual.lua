...
RegisterNetEvent("RageUIjh:Popup")
AddEventHandler("RageUIjh:Popup", function(array)
    RageUIjh.Popup(array)
end)

---Popup
---@param array table
---@public
function RageUIjh.Popup(array)
    ClearPrints()
...
---@param array table
---@public
function RageUIjh.PopupChar(array)
    if (array.colors == nil) then
        SetNotificationBackgroundColor(140)
    else
        SetNotificationBackgroundColor(array.colors)
