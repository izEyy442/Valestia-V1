...
---@return table
---@public
function RageUIjh.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = RageUIjh.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = 100
    Menu.Open = false
    Menu.Controls = RageUIjh.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + RageUIjh.Settings.Items.Subtitle.Text.X, Menu.Y + RageUIjh.Settings.Items.Subtitle.Text.Y, 0, RageUIjh.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIjh.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, RageUIjh.Menus)
end
...
---@return table
---@public
function RageUIjh.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
...
---@return nil
---@public
function RageUIjh.Menus:SetTitle(Title)
    self.Title = Title
end
...
---@return nil
---@public
function RageUIjh.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function RageUIjh.Menus:GetStyleSize()
...
---@return void
---@public
function RageUIjh.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function RageUIjh.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function RageUIjh.Menus:UpdateCursorStyle()
...
---@return void
---@public
function RageUIjh.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function RageUIjh.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + RageUIjh.Settings.Items.Subtitle.Text.X, self.Y + RageUIjh.Settings.Items.Subtitle.Text.Y, 0, RageUIjh.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIjh.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function RageUIjh.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function RageUIjh.Menus:EditSpriteColor(color)
...
---@return nil
---@public
function RageUIjh.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function RageUIjh.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function RageUIjh.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function RageUIjh.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function RageUIjh.Menus:Closable(boolean)
...
function RageUIjh.Menus:AddInstructionButton(button)
...
function RageUIjh.Menus:RemoveInstructionButton(button)
...
function RageUIjh.Menus:UpdateInstructionalButtons(Visible)
