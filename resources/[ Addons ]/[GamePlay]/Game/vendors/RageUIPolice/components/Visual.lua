...
RegisterNetEvent("RageUIPolice:Popup")
AddEventHandler("RageUIPolice:Popup", function(array)
    RageUIPolice.Popup(array)
end)

---Popup
---@param array table
---@public
function RageUIPolice.Popup(array)
    ClearPrints()
...
---@param array table
---@public
function RageUIPolice.PopupChar(array)
    if (array.colors == nil) then
        SetNotificationBackgroundColor(140)
    else
        SetNotificationBackgroundColor(array.colors)
...
---@param array table
---@public
function RageUIPolice.Text(array)
    ClearPrints()
