...
---@return nil
---@public
function RageUIv1.List(Label, Items, Index, Description, Style, Enabled, Callback, onListChange, Submenu)
    ---@type table
            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                ...
                if Enabled == true or Enabled == nil then
                    if Selected then
                        ...
                        RenderText(ListText, CurrentMenu.X + SettingsList.Text.X + 15 + CurrentMenu.WidthOffset - RightOffset, CurrentMenu.Y + SettingsList.Text.Y + CurrentMenu.SubtitleHeight + RageUIv1.ItemOffset, 0, SettingsList.Text.Scale, 0, 0, 0, 255, 2)
                    else
