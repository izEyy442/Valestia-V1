...
RegisterNetEvent("RageUIClothes:Popup")
AddEventHandler("RageUIClothes:Popup", function(array)
...
---@param array table
---@public
function RageUIClothes.Popup(array)
    ClearPrints()
...
---@param array table
---@public
function RageUIClothes.PopupChar(array)
    if (array.colors == nil) then
        SetNotificationBackgroundColor(140)
    else
        SetNotificationBackgroundColor(array.colors)
...
---@param array table
---@public
function RageUIClothes.Text(array)
    ClearPrints()
