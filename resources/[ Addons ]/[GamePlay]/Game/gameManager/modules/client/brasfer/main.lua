...
Citizen.CreateThread(function()
  ...
  Citizen.CreateThread(function()
    while true do
      if disabledControl == 1 or disabledControl == 2 then 
        Wait(0)
      else
        Wait(1500)
      end
  ...
  AddEventHandler('evy_arm:start_cl', function()
    ...
    if place == 1 then
      ...
      if grade >= 0.90 then
        ...
        notify("~HUD_COLOUR_PM_WEAPONS_PURCHASABLE~" .. text[Bras.language]['win'])
      elseif grade <= 0.10 then
        PlayAnim(PlayerPedId(), "mini@arm_wrestling", "win_a_ped_b", 2)
        notify("~HUD_COLOUR_PM_WEAPONS_PURCHASABLE~" .. text[Bras.language]['lose'])
      end
      Wait(4000)
  ...
  AddEventHandler('evy_arm:check_cl', function(args)
    ...
    elseif args == 'noplace' then
      ...
      notify('~HUD_COLOUR_PM_WEAPONS_PURCHASABLE~' ..text[Bras.language]['full'])
