...
Config.Translate = {
    ['CANNOT_START'] = "Vous ne pouvez pas déclencher plusieurs feux d'artifice à la fois, attendez que celui en cours se déclenche", -- Only if: Config.DisableMultiplyFireworks = true
    ['NEED_LIGHTER'] = "Il vous faut un briquet !", -- Only if: Config.NeedLighter = true
