...
---@return table
---@public
function RageUIJob.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = RageUIJob.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = RageUIJob.UI.Style[RageUIJob.UI.Current].Width
    Menu.Open = false
    Menu.Controls = RageUIJob.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + RageUIJob.Settings.Items.Subtitle.Text.X, Menu.Y + RageUIJob.Settings.Items.Subtitle.Text.Y, 0, RageUIJob.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIJob.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, RageUIJob.Menus)
end
...
---@return table
---@public
function RageUIJob.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
...
---@return nil
---@public
function RageUIJob.Menus:SetTitle(Title)
    self.Title = Title
end
...
---@return nil
---@public
function RageUIJob.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function RageUIJob.Menus:GetStyleSize()
...
---@return void
---@public
function RageUIJob.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function RageUIJob.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function RageUIJob.Menus:UpdateCursorStyle()
...
---@return void
---@public
function RageUIJob.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function RageUIJob.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + RageUIJob.Settings.Items.Subtitle.Text.X, self.Y + RageUIJob.Settings.Items.Subtitle.Text.Y, 0, RageUIJob.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIJob.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function RageUIJob.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function RageUIJob.Menus:EditSpriteColor(color)
...
---@return nil
---@public
function RageUIJob.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function RageUIJob.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function RageUIJob.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function RageUIJob.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function RageUIJob.Menus:Closable(boolean)
...
function RageUIJob.Menus:AddInstructionButton(button)
...
function RageUIJob.Menus:RemoveInstructionButton(button)
...
function RageUIJob.Menus:UpdateInstructionalButtons(Visible)
