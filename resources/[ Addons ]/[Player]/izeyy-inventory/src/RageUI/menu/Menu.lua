...
---@return lgdUIMenus
---@public
function lgdUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ---@type table
    local Menu = {}
    Menu.Display = {};
    ...
    Menu.DescriptionHeight = lgdUI.Settings.Items.Description.Background.Height
    Menu.X = X or 25
    Menu.Y = Y or 69
    Menu.Parent = nil
    Menu.WidthOffset = lgdUI.UI.Style[lgdUI.UI.Current].Width
    Menu.Open = false
    Menu.Controls = lgdUI.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + lgdUI.Settings.Items.Subtitle.Text.X, Menu.Y + lgdUI.Settings.Items.Subtitle.Text.Y, 0, lgdUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, lgdUI.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, lgdUI.Menus)
end
...
---@return lgdUIMenus
---@public
function lgdUI.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    if ParentMenu ~= nil then
        if ParentMenu() then
            local Menu = lgdUI.CreateMenu(Title or ParentMenu.Title, Subtitle or string.upper(ParentMenu.Subtitle), X or ParentMenu.X, Y or ParentMenu.Y)
...
---@return nil
---@public
function lgdUI.Menus:SetTitle(Title)
    self.Title = Title
end

function lgdUI.GetInMenu()
    local inMenu = false
...
function lgdUI.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function lgdUI.Menus:GetStyleSize()
...
---@return void
---@public
function lgdUI.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function lgdUI.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function lgdUI.Menus:UpdateCursorStyle()
...
---@return void
---@public
function lgdUI.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function lgdUI.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + lgdUI.Settings.Items.Subtitle.Text.X, self.Y + lgdUI.Settings.Items.Subtitle.Text.Y, 0, lgdUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, lgdUI.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function lgdUI.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function lgdUI.Menus:EditSpriteColor(R, G, B, A)
...
---@return nil
---@public
function lgdUI.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function lgdUI.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function lgdUI.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function lgdUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function lgdUI.Menus:Closable(boolean)
...
function lgdUI.Menus:AddInstructionButton(button)
...
function lgdUI.Menus:RemoveInstructionButton(button)
...
function lgdUI.Menus:UpdateInstructionalButtons(Visible)
