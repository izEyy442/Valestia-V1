...
function ESX.ShowNotification(msg, flash, saveToBrief, hudColorIndex)
	local isInInventory = exports["izeyy-inventory"]:getInInventory()

    if IsPauseMenuActive() then return end

	if isInInventory then
		TriggerEvent('inv:Notification', msg)
	else
...
function ESX.OpenSocietyMenu(societyName)
	exports["vCore3"]:OpenSocietyMenu(societyName);
end

---@param societyName string
function ESX.OpenSocietyChest(societyName)
	exports["vCore3"]:OpenSocietyChest(societyName);
end

---@param societyName string
---@param plate string
function ESX.ParkSocietyVehicle(societyName, plate)
	exports["vCore3"]:ParkSocietyVehicle(societyName, plate);
end

---@param societyName string
---@param coords vector3
function ESX.OpenSocietyGarage(societyName, coords)
	exports["vCore3"]:OpenSocietyGarage(societyName, coords);
end
